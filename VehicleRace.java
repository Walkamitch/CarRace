...
public class VehicleRace {
    ...
    public static int checkForKart(Vehicle car1, int speed, Vehicle car2) {
        int newSpeed;
        if (car1 instanceof Kart) {
            int num1 = ((Kart) car1).attack();
            newSpeed = speed - num1;
            if (num1 == 7) {
            System.out.println(ConsoleColors.RED + "Car1 attacked car2 with green shell, got slowed down by " + num1 + " points." + ConsoleColors.RESET);
            } else if (num1 == 5) {
                System.out.println(ConsoleColors.BLUE + "Car1 attacked car2 with Boomerang, got slowed down by " + num1 + " points." + ConsoleColors.RESET);
            } else if (num1 == 1) {
                System.out.println(ConsoleColors.YELLOW + "Car1 attacked car2 with Banana, got slowed down by " + num1 + " points." + ConsoleColors.RESET);
            }
            return speed;
        } else {
            return speed;
